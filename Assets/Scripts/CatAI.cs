...
public class CatAI : MonoBehaviour
{
    ...
    [Header("Cone Sprites")]
    public Sprite coneOpacity; // Default cone
    public Sprite cone;        // Alert cone
    ...
    void Start()
    {
        ...
        coneRenderer = transform.GetChild(3).GetComponent<SpriteRenderer>();
        if (coneRenderer != null)
        {
            coneRenderer.sprite = coneOpacity; // Default sprite
        }
        // if (spotLight != null)
        // {
    ...
    void Update()
    {
        ...
        if (CanSeeMouse())
        {
          ...
          //  ChangeSpotlightColor(Color.red); // Set light to red
            ChangeConeSprite(cone); // Switch to "alert" sprite
            questionMarkPanel.SetActive(false);
       ...
       // ChangeSpotlightColor(originalColor);
        ChangeConeSprite(coneOpacity); // Switch to "default" sprite
        questionMarkPanel.SetActive(false);
  ...
  /*  void ChangeSpotlightColor(Color newColor)
    ...
    void ChangeConeSprite(Sprite newSprite)
    {
        if (coneRenderer != null)
        {
            coneRenderer.sprite = newSprite;
        }
    }
