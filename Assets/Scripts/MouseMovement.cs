...
public class MouseMovement : MonoBehaviour
{
    ...
    public GameObject pickKeyObj;
    public GameObject pickLeverObj;
    ...
    private void OnTriggerEnter(Collider other)
    {
            ...
            if (targetChild.childCount == 0)
            {
                ...
                if (transform.childCount > 0 && weaponPrefabs.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        Debug.Log("Local Pistol Pos:"+newWeapon.transform.localPosition+ "Local Rot:"+newWeapon.transform.localRotation);
                    }
        ...
        if (other.CompareTag("Lever") && !leverPulled) // tag your lever collider as "Lever"
        {
            ...
            if(pickLeverObj != null)
            Destroy(pickLeverObj);
        }
